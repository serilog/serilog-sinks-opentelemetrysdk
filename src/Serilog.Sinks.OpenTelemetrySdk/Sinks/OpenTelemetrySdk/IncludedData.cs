...
public enum IncludedData
{
    ...
    /// <summary>
    /// Preserve the value of the <c>SourceContext</c> property, in addition to using it as the OpenTelemetry <c>InstrumentationScope</c> name. If
    ...
    /// dictionaries for OpenTelemetry.
    /// </summary>
